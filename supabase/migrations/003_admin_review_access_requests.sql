-- Atomic admin review workflow for pending access requests.
-- Cloudflare Functions still authenticate the caller, but this function keeps
-- request review, member provisioning, and audit logging together in one DB transaction.
